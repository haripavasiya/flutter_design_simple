...
class NewDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget _messageWidget = Text(widget.description, style: montserratMedium,);
          ...
          Row(children: <Widget>[
            ...
            Expanded(
                child: MaterialButton(height: 50, minWidth: double.infinity,
                  ...
                  child: Text(widget.rightButtonText, style: montserratRegular.copyWith(color: Colors.black),),
            )),
          ])
        ],
      ),
